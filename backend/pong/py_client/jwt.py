...
class JWTClient:
    ...
    base_endpoint = "https://0.0.0.0:8000/"
    ...
    def perform_auth(self):
        ...
        r = requests.post(endpoint, json={'username': username, 'password': password}, verify=False) 
    ...
    def verify_token(self):
        ...
        r = requests.post(endpoint, json=data, verify=False)
